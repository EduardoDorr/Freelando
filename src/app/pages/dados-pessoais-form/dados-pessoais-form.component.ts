...
import { getDadosPesossaisFormConfig } from '../../config/dados-pessoais-form.config';
...
export class DadosPessoaisFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.dynamicFormService.registerFormConfig('dadosPessoais', getDadosPesossaisFormConfig);
  }

  ngOnInit(): void {
    this.formConfig = this.dynamicFormService
      .getFormConfig('dadosPessoais', this.emailService);

    const formOptions: AbstractControlOptions = {
      validators: senhasIguaisValidator
    };

    this.dadosPessoaisForm = this.dynamicFormService
      .createFormGroup(this.formConfig, formOptions);
