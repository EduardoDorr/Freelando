...
interface CadastroData {
  ...
  resumo?: string,
  habilidadeSelecionadas?: Array<Habilidade>,
...
export class CadastroService {
  private cadastroDataSubject =
    new BehaviorSubject<CadastroData>({});
  ...
  updateCadastroData(data: Partial<CadastroData>): void {
    ...
    localStorage.setItem('cadastro', JSON.stringify(updatedData));
  }
